 ...
 */
package ioc.annotation.b03constructor;
...
public class UseBean3constructor {
...
//	}
	 ...
	 */
//	@Autowired
	public UseBean3constructor(HelloBean hb) {
		this.helloBean = hb;
//		System.out.println("b03constructor：使用构造器进行装配，注解不能实现多个继承类的情况，故使用xml");
	}
	/**
	 * 初始化
	 */
